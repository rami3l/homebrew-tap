# Modified from: https://github.com/Homebrew/homebrew-cask-fonts/blob/ce88d88105f5b195146422c1630c75d963029d25/Casks/font-d2coding.rb

cask "font-d2coding-all" do
    ...
    font "D2CodingAll/D2Coding-Ver#{version.csv.first}-#{version.csv.second}-all.ttc"
end
